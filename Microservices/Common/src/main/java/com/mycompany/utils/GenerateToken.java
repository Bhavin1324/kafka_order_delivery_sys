...
import static com.mycompany.utils.Constants.ROLE_ADMIN;
import static com.mycompany.utils.Constants.ROLE_CUSTOMER;
import static com.mycompany.utils.Constants.ROLE_DELIVERY_PERSON;
import static com.mycompany.utils.Constants.ROLE_RESTAURANT;
...
private static String key;
    ...
    public static String getKey() {
      ...
      public static String generateJWT(String role,long exptime) {
        ...
        token.setSub("pizzahunt");  // Sub is required for WildFly Swarm
        token.setUpn("pizzahuntUPN");
