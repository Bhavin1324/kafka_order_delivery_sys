...
const OutletForm = ({onAdd , update , action}:{ onAdd: (outlet: Outlet) => void;update:Outlet;action:string}) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const phoneRegister = register("phoneno", {
  ...
  const longitudeRegister = register("longitude", {
    required: "longitude is required !",
  });
  const latitudeRegister = register("latitude", {
    ...
    >
      ...
      <div className="flex flex-col mb-2">
        ...
        <input
          ...
          className="rounded-md border-gray-300 focus:border-blue-500 px-2 py-1"
        />
        <p style={{ color: 'red' }}>{errors?.phoneno && errors?.phoneno.message}</p>
      ...
      <div className="flex flex-col mb-2">
        ...
        <input
          ...
          className="rounded-md border-gray-300 focus:border-blue-500 px-2 py-1"
        />
       <p style={{ color: 'red' }}>{errors?.latitude && errors?.latitude.message}</p>
      ...
      <div className="flex flex-col mb-2">
        ...
        <input
          ...
          className="rounded-md border-gray-300 focus:border-blue-500 px-2 py-1"
        />
         <p style={{ color: 'red' }}>{errors?.longitude && errors?.longitude.message}</p>
