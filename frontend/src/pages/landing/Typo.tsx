...
function Typo() {
  ...
  return (
    <div className="absolute top-0 lg:translate-x-[10%] xl:translate-x-[15%] 2xl:translate-x-[25%] home-section container mx-auto p-3 min-h-[500px] lg:min-h-[650px] overflow-hidden select-none">
